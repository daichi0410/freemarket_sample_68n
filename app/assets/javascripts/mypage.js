window.addEventListener("turbolinks:load", function() {
  ...
  let tabs = document.getElementsByClassName("hako__right__1__middle__left");
  let btns = document.getElementsByClassName("hako__right__2__middle__left");
  ...
  function tabSwitch() {
    ...
    document.getElementsByClassName("hako__right__1__under")[index].classList.add("show");
  }
  function btnSwitch() {
    ...
    document.getElementsByClassName("hako__right__2__under")[index].classList.add("see");
  }
